...
You can use this https://start.spring.io/#!type=gradle-project&groupId=com.example&artifactId=uploading-files&language=java&jvmVersion=17&packageName=com.example.uploading-files&dependencies=web,thymeleaf[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
...
`spring-boot-starter-thymeleaf` and `spring-boot-starter-webmvc` are already added as
